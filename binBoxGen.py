...
f.write('<text font-family="Verdana" font-size="' + str(fontSize) + '" x="' +str((L/2)+1.25*H+2*t+x_offset-fontSize) + '" y="' + str(y_offset+(fontSize*(4/3))) +
        '" fill="black" transform="rotate(270, ' + str((L/2)+1.25*H+2*t+x_offset-fontSize) + ', ' + str(y_offset+(fontSize*(4/3))) + ')">Hods </text>\n')
f.write('<text font-family="Verdana" font-size="' + str(fontSize) + '" x="' +str((L/2)+1.25*H+2*t+x_offset) + '" y="' + str(y_offset+fontSize*(6/3)) +
        '" fill="black" transform="rotate(270, ' + str((L/2)+1.25*H+2*t+x_offset) + ', ' + str(y_offset+fontSize*(6/3)) + ')">Fun Box </text>\n')
...
f.write('<polygon points="'+str(x_offset-L/4)+','+str(H*(1/16+7/32))+' '+str(x_offset-L/4)+','+str(H*(1/16+21/32))+' '+str(x_offset)+','+str(H*(15/16))+' '+str(x_offset+L/4)+','+str(H*(1/16+21/32))+' '+str(x_offset+L/4)+','+str(H*(1/16+7/32))+' '+str(x_offset)+','+str(H*(1/16))+'"  style="fill:none;stroke:green;stroke-width:1" />')
f.write('<line x1="'+str(x_offset-L/4)+'" y1="'+str(H*(1/16+7/32))+'" x2="'+str(x_offset+L/4)+'" y2="'+str(H*(1/16+21/32))+'" stroke = "green" stroke-width="1"/>\n')
f.write('<line x1="'+str(x_offset-L/4)+'" y1="'+str(H*(1/16+21/32))+'" x2="'+str(x_offset+L/4)+'" y2="'+str(H*(1/16+7/32))+'" stroke = "green" stroke-width="1"/>\n')
f.write('<line x1="'+str(x_offset)+'" y1="'+str(H*(1/16))+'" x2="'+str(x_offset)+'" y2="'+str(H*(15/16))+'" stroke = "green" stroke-width="1"/>\n')
"""
f.write('<defs>\n')
f.write('   <g id="hex">\n')
f.write('      <polygon points="229.3,627.5 83.6,375.5 229.3,123.5 520.7,123.5 666.4,375.5 520.7,627.5" 	style="fill:none;stroke:black;stroke-width:3" />\n')
f.write('      <line x1="'+str(x_offset-L/4)+'" y1="'+str(H*(1/16+7/32))+'" x2="'+str(x_offset+L/4)+'" y2="'+str(H*(1/16+21/32))+'" stroke = "blue" stroke-dasharray="1"/>\n')
f.write('      <line x1="'+str(x_offset-L/4)+'" y1="'+str(H*(1/16+21/32))+'" x2="'+str(x_offset+L/4)+'" y2="'+str(H*(1/16+7/32))+'" stroke = "blue" stroke-dasharray="1"/>\n')
f.write('      <line x1="'+str(x_offset)+'" y1="'+str(H*(1/16+7/32))+'" x2="'+str(x_offset)+'" y2="'+str(H*(1/16+21/32))+'" stroke = "blue" stroke-dasharray="1"/>\n')
f.write('   </g>\n')
f.write('</defs>\n') 
